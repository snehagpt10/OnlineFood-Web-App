    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('total_data', models.FloatField()),
                ('payment_method', models.CharField(max_length=25)),
                ('status', models.CharField(choices=[('New', 'New'), ('Accepted', 'Accepted'), ('Completed', 'Complete'), ('Cancelled', 'Cancelled')], default='New', max_length=15)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('payment', models.CharField(choices=[('PayPal', 'PayPal'), ('RazorPay', 'RazorPay')], max_length=100)),
