...
# MEDIA_URL: The URL endpoint for media files
MEDIA_URL = '/media/'

# MEDIA_ROOT: The directory on the filesystem where uploaded files will be stored
...
EMAIL_PORT=587
EMAIL_HOST_USER='v.verm3737@gmail.com'
EMAIL_HOST_PASSWORD='ditcjbluvkaikgpx' # Your app password here
EMAIL_USE_TLS=True
